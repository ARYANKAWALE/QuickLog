        ...
        >
          ...
          {gridLines.map((v, i) => (
            <line
              ...
              y1={yOf(v)}
              y2={yOf(v)}
              stroke="var(--color-separator,#e4e4e7)"
              strokeWidth="1"
              strokeDasharray="4 4"
            />
          ))}
    ...
    <div style={{ ...card, marginTop: 16, paddingBottom: 18 }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span
            style={{ fontSize: 12, color: "var(--color-secondary,#5f5e60)" }}
          >
            Less
          </span>
          {levelColors.map((c, i) => (
      ...
      >
        You completed{" "}
        <strong style={{ color: "var(--color-on-surface,#1a1b23)" }}>
        ...
        {workoutCount >= 30
          ...
          : workoutCount >= 10
            ? "Keep it up!"
            : "Log more sessions to build your streak."}
      </p>
    </div>
  );
}
...
function PersonalRecordsPanel({ records }) {
  ...
  const newestDate = records.length
...
function LogSessionModal({ isOpen, onClose, onSaved }) {
  ...
  const [exercises, setExercises] = useState([
    { exercise: "", sets: 3, reps: 10, weight: 0, unit: "kg" },
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (json.success) {
        ...
        onClose();
        setExercises([
          { exercise: "", sets: 3, reps: 10, weight: 0, unit: "lbs" },
        ]);
        setNotes("");
      }
    } catch (err) {
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            placeholder="e.g. Leg day, felt strong"
            style={inputStyle}
          />
          ...
          {exercises.map((ex, i) => (
            <div
              ...
              style={{
                display: "grid",
                gridTemplateColumns: "2fr 1fr 1fr 1fr 60px 32px",
                gap: 6,
                marginBottom: 8,
                alignItems: "center",
              }}
            >
              ...
              <input
                ...
                value={ex.sets}
                onChange={(e) =>
                  updateRow(i, "sets", parseInt(e.target.value) || 1)
                }
                style={{ ...inputStyle, margin: 0 }}
              />
              <input
                ...
                value={ex.reps}
                onChange={(e) =>
                  updateRow(i, "reps", parseInt(e.target.value) || 1)
                }
                style={{ ...inputStyle, margin: 0 }}
              />
              <input
                ...
                value={ex.weight}
                onChange={(e) =>
                  updateRow(i, "weight", parseFloat(e.target.value) || 0)
                }
                style={{ ...inputStyle, margin: 0 }}
              />
              <select
          ...
          <button
            ...
            style={{
              ...
              gap: 6,
              background: "none",
              border: "1.5px dashed var(--color-separator,#e4e4e7)",
              borderRadius: 8,
              padding: "8px 14px",
              cursor: "pointer",
              fontSize: 13,
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          Start tracking your strength gains, activity, and personal records by
          logging your first workout session.
        </p>
      </div>
      <button
  ...
  const fetchDashboard = async () => {
    try {
      ...
      const res = await fetch(
        `${BACKEND_URL}/dashboard?exercise=${encodeURIComponent(selectedExercise)}`,
      );
      const json = await res.json();
        ...
        >
          <div
            style={{
              width: 44,
              height: 44,
              border: "4px solid var(--color-primary,#0057bf)",
          ...
          <span
            style={{ fontSize: 14, color: "var(--color-secondary,#5f5e60)" }}
          >
    ...
    return (
      ...
      >
        ...
        >
          <span
            className="material-symbols-outlined"
            style={{ fontSize: 44, color: "var(--color-error,#ba1a1a)" }}
          >
            error
          </span>
          <p
    ...
    return (
      <main className="flex-grow pt-24 pb-section-gap px-gutter-desktop max-w-[1440px] mx-auto w-full flex items-center justify-center min-h-[60vh]">
        ...
        >
          ...
          >
            You need to be logged in to access your Progress dashboard. Track
            your daily progress.
          </p>
      ...
      >
        ...
        >
          <div>
            ...
            >
              A deep dive into your athletic evolution. Tracking your
              consistency, strength gains, and personal milestones.
            </p>
          </div>
          <div
            style={{
            ...
            <div>
              {strengthHistory?.length >= 2 ? (
                ...
                <div style={{ ...card, paddingBottom: 22 }}>
                  ...
                  >
                    Log at least 2 sessions with <em>{selectedExercise}</em>{" "}
                    across different months to see your strength progress chart.
                  </p>
                </div>
              )}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {currentWeight ? (
                ...
                <div style={{ ...card, paddingBottom: 20 }}>
                  ...
                  >
                    No weight logged yet. Use the Log Session form or add a
                    weight entry.
                  </p>
                </div>
              )}
                ...
                <StatCard
                  ...
                  trend={
                    consistency.streakDays > 0
                      ? `${consistency.streakDays}-day streak`
                      : "No active streak"
                  }
                  trendColor={
                    consistency.streakDays >= 7 ? "#16a34a" : "#c05400"
                  }
                />
              )}
